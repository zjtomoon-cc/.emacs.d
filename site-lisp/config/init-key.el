...
(lazy-one-key-create-menu "code-lsp"
			  ...
			  (:key "n" :description "next error" :command flycheck-next-error :filename "flycheck")
			  (:key "p" :description "prev error" :command flycheck-previous-error :filename "flycheck")
